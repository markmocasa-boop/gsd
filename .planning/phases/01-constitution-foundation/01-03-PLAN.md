...
<verification>
Run `npm install` (or link locally) - global CONSTITUTION.md created in ~/.claude/get-shit-done/.
Run `/gsd:new-project` in test directory - project CONSTITUTION.md created in .planning/.
